...
<div class="print-footer">
  ...
  return (
    <>
      ...
      <div
        dir="rtl"
        className="min-h-screen bg-gradient-to-br from-white via-[#faf5e8] to-[#f5e9d8] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-6 relative font-sans overflow-hidden transition-colors duration-300"
      >
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <FaCalendar className="text-[#C28B46] text-xl" />
              ...
              >
                <div>
                  ...
                  <div className="relative">
                    ...
                    <DatePicker
                      ...
                      className="w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#C28B46] focus:border-transparent outline-none text-right"
                      locale="ar"
                ...
                <div>
                  ...
                  <div className="relative">
                    <FaClock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#C28B46]" />
                    <input
                      type="time"
                      value={startTime}
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg px-3 py-2.5 text-right focus:ring-2 focus:ring-[#C28B46] focus:border-transparent outline-none hover:border-[#C28B46] transition-all group"
                    >
                      <div className="flex items-center gap-3">
                        <FaBuilding className="text-[#C28B46] text-sm" />
                          ...
                          <div
                            ...
                            className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-all text-sm border-b dark:border-gray-600 last:border-b-0 ${
                              selectedBranch?.id === branch.id
                                ? "bg-gradient-to-r from-[#faf5e8] to-[#f5e9d8] dark:from-gray-700 dark:to-gray-600"
                                : ""
                            }`}
                          >
                            <span className="text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex gap-3">
                    <motion.button
                      ...
                      className={`flex-1 px-4 py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 ${
                        startDate && endDate
                          ? "bg-[#C28B46] text-white cursor-pointer hover:bg-[#b07a3a] border border-[#C28B46]"
                            ...
                            >
                              ...
                              <td className="px-4 py-3 text-center">
                                <motion.button
                                  ...
                                  className="flex items-center justify-center gap-2 px-4 py-2 bg-[#C28B46] text-white rounded-lg text-sm font-medium hover:shadow-lg transition-all duration-300 mx-auto hover:bg-[#b07a3a] border border-[#C28B46]"
                                >
                                  {loadingDetails &&
